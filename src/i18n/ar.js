const ar = {
  ...
  hero: {
    ...
    title: 'مهندس برمجيات',
    description:
      'مهندس برمجيات متخصص في بناء تطبيقات حديثة وفعّالة باستخدام Flutter و Laravel والهندسة المعمارية النظيفة. شغوف بالكود النظيف والقابلية للتوسع والتعلم المستمر.',
    projectsBtn: 'مشاريعي',
  ...
  about: {
    ...
    titleHighlight: 'نفسي',
    description:
      'أنا مهندس برمجيات حاصل على درجة البكالوريوس في هندسة البرمجيات من كلية تقنية المعلومات الجميل، جامعة صبراتة. أركز على تطوير تطبيقات الموبايل باستخدام Flutter وتطوير أنظمة الويب باستخدام Laravel وPHP وMySQL. أهتم ببناء برمجيات قابلة للتوسع، وكتابة كود نظيف وقابل للصيانة، وتطبيق مبادئ هندسة البرمجيات لتقديم حلول عملية وتجارب مستخدم عالية الجودة.',
    stat1Label: 'التعليم',
  ...
  skills: {
    ...
    htmlcss: {
      ...
      percent: '90%',
      description:
        'تصميم تخطيطات متجاوبة ورسوم متحركة ومكونات واجهة مستحدم حديثة بأنماط CSS نظيفة وقابلة للصيانة.',
    },
  },
