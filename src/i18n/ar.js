const ar = {
  ...
  about: {
    ...
    titleHighlight: 'نفسي',
    description:
      'أنا مهندس برمجيات متحصل على درجة البكالوريوس في هندسة البرمجيات من كلية تقنية المعلومات الجميل، جامعة صبراتة. أتخصص في بناء تطبيقات الموبايل القابلة للتوسع باستخدام Flutter وتطوير الويب الشامل باستخدام Laravel و PHP. أركز على الهندسة المعمارية النظيفة والكود الفعّال وتقديم تجارب مستخدم عالية الجودة.',
    stat1Label: 'التعليم',
